...
namespace src.Model.ModelFramework.ActionFramework.ActionModels
{
    public class WeaponModel : ActionModel
    {
        ...
        public WeaponModel(string actionName, ActionTime actionTime, int actionLevel, string description,
            string roomModel, IEnumerable<WeaponTurnModel> weaponTurnModel, ActionPriority priority) : base(actionName,
