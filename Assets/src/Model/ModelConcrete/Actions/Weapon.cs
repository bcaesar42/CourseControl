...
{
    public class Weapon : ModelFramework.ActionFramework.Action
    {
        public Weapon(TargetManager targetManager, Guid actionId, Guid actionInstanceId, Guid selfId, Guid teamId) : base(targetManager, actionId, actionInstanceId, selfId, teamId)
        {
        }
