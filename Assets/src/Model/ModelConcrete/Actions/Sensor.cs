...
{
    public class Sensor: ModelFramework.ActionFramework.Action
    {
        public Sensor(TargetManager targetManager, Guid actionId, Guid actionInstanceId, Guid selfId, Guid teamId) : base(targetManager, actionId, actionInstanceId, selfId, teamId)
        {
        }
