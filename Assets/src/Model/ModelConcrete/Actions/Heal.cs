...
{
    public class Heal: ModelFramework.ActionFramework.Action
    {
        public Heal(TargetManager targetManager, Guid actionId, Guid actionInstanceId, Guid selfId, Guid teamId) : base(targetManager, actionId, actionInstanceId, selfId, teamId)
        {
        }
